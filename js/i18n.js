export const translations = {
  ...
  // Clinic
  clinic: { ar: 'العيادة المدرسية', en: 'School Clinic' },
  clinicVisits: { ar: 'سجل الزيارات', en: 'Visit Records' },
  todayVisits: { ar: 'زيارات اليوم', en: "Today's Visits" },
  addVisit: { ar: 'تسجيل زيارة', en: 'Add Visit' },
  symptoms: { ar: 'الأعراض', en: 'Symptoms' },
  diagnosis: { ar: 'التشخيص', en: 'Diagnosis' },
  actionTaken: { ar: 'الإجراء المتخذ', en: 'Action Taken' },
  action_rest: { ar: 'راحة في العيادة', en: 'Rest in Clinic' },
  action_home: { ar: 'إرسال للمنزل', en: 'Sent Home' },
  action_hospital: { ar: 'تحويل للمستشفى', en: 'Referred to Hospital' },
  action_medicine: { ar: 'إعطاء دواء والعودة', en: 'Medicine & Return' },
  visitTime: { ar: 'وقت الزيارة', en: 'Visit Time' },
  medicalExcuse: { ar: 'عذر طبي', en: 'Medical Excuse' },
  medicalExcuseNote: { ar: 'مُعفى طبياً — تم التحويل من العيادة', en: 'Medical Excuse — Referred from Clinic' },
  totalVisits: { ar: 'إجمالي الزيارات', en: 'Total Visits' },
  sentHome: { ar: 'أُرسلوا للمنزل', en: 'Sent Home' },
  referred: { ar: 'محوّلون للمستشفى', en: 'Referred' },
  ...
  academicAnalytics:{ ar: 'التحليل الأكاديمي',   en: 'Academic Analytics'  },
  attendanceAnalytics:{ ar: 'تحليل الحضور',      en: 'Attendance Analytics'},
  financeAnalytics: { ar: 'التحليل المالي',       en: 'Finance Analytics'   },
  topStudents:      { ar: 'أعلى الطلاب',          en: 'Top Students'        },
  needsSupport:     { ar: 'يحتاجون دعماً',        en: 'Needs Support'       },
  // Audit Log
  auditLog:         { ar: 'سجل التدقيق',  en: 'Audit Log'  },
  action:           { ar: 'العملية',       en: 'Action'     },
  actor:            { ar: 'المستخدم',     en: 'User'       },
  createAction:     { ar: 'إضافة',        en: 'Create'     },
  updateAction:     { ar: 'تعديل',        en: 'Update'     },
  ...
  serialNo:         { ar: 'الرقم التسلسلي', en: 'Serial No.'     },
  supplier:         { ar: 'المورّد',      en: 'Supplier'         },
  purchaseDate:     { ar: 'تاريخ الشراء', en: 'Purchase Date'    },
  requestMaintenance:{ ar: 'طلب صيانة',  en: 'Request Maintenance'},
  // Export
